...
(
    ...
    FILENAME='F:\ITI\SQL\Project SQL\project\ExaminationSystem\Examination_System.mdf',
    SIZE=4MB,
    MAXSIZE=10MB,
    FILEGROWTH=1MB
),
(
     NAME='Examination_System2',
    FILENAME='F:\ITI\SQL\Project SQL\project\ExaminationSystem\Examination_System2.ndf',
    SIZE=4MB,
    MAXSIZE=10MB,
    FILEGROWTH=1MB
),
...
FILEGROUP SECONDARY 
(
  NAME='Examination_System3',
    FILENAME='F:\ITI\SQL\Project SQL\project\ExaminationSystem\Examination_System3.ndf',
    SIZE=4MB,
    MAXSIZE=10MB,
    FILEGROWTH=1MB
),
(
  NAME='Examination_System4',
    FILENAME='F:\ITI\SQL\Project SQL\project\ExaminationSystem\Examination_System4.ndf',
    SIZE=4MB,
    MAXSIZE=10MB,
    FILEGROWTH=1MB
)
...
(
    ...
    FILENAME='F:\ITI\SQL\Project SQL\project\ExaminationSystem\Examination_System_Log.ldf',
    SIZE=4MB,
    MAXSIZE=10MB,
    FILEGROWTH=1MB
)
...
FOREIGN KEY (CourseID)REFERENCES [CourseData].[Course](ID)ON DELETE CASCADE ON UPDATE CASCADE,
)


alter table [StudentData].[DIBT] add IsDeleted int not null default 0
go
insert into [StudentData].[DIBT] values(1,1,1,1,1,1,default),(2,2,2,2,2,2,default),(3,3,3,3,3,3,default);

--truncate table [StudentData].[DIBT]
